...
lint: ## Run linting
	python -m py_compile src/api_doc_gen/core.py
	python -m py_compile src/api_doc_gen/cli.py
	python -m py_compile src/api_doc_gen/web_ui.py

run: ## Generate docs (usage: make run SRC=./src)
